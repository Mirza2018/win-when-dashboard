...
const AllServiceUserTable = ({
  data,
  loading,
  showViewServiceUserModal,
  pageSize = 0,
}) => {
  // State for the search term in the company filter and selected company name
  ...
  return (
    <div>
      <Table
        columns={columns}
        dataSource={filteredData} // Use the filtered data here based on selected company
        loading={loading}
...
export default AllServiceUserTable;
